...
select o.OrderID,o.OrderDate,o.Quantity,e.FirstName,e.LastName
from orders as o
join Customers as e
on o.CustomerID=e.CustomerID;

select o.OrderID,o.CustomerID,o.ProductID,o.OrderDate,o.Quantity, o.TotalAmount, o.PaymentStatus,p.ProductName
from orders as o
join Products as p
on o.ProductID = p.ProductID;

select o.OrderID,o.CustomerID,o.ProductID,o.OrderDate,o.Quantity, o.TotalAmount, o.PaymentStatus,c.FirstName,c.lastName,c.Email,c.Phone
from orders as o
join Customers as c
on o.CustomerID=c.CustomerID;

select c.FirstName,c.lastName,c.Email,c.Phone , count(orderid)
from orders as o
join Customers as c
on o.CustomerID=c.CustomerID
...
SELECT o.OrderID, o.OrderDate, o.Quantity, o.TotalAmount, o.PaymentStatus, c.CustomerID, c.FirstName, c.LastName ,c.Email, c.Country
from Orders as o
join  Customers c 
on o.CustomerID = c.CustomerID
where c.Country = 'USA';
